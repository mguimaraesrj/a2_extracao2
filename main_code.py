...
st.write("###### Não sabe o ticker da companhia que está analisando? Basta buscar por sua empresa de interesse.")
...
if st.sidebar.button("Analisar"):
    try:
        ...
        if precos is None or noticias is None:
            ...
            st.text_area("ℹ️ O que é o Movimento Browniano Geométrico (MBG)?",
                value="O MBG simula trajetórias futuras de preços de ações usando retornos log-normais, "
                      "considerando média e volatilidade históricas. "
                      "Ele é empregado para estimar a probabilidade de atingir um determinado retorno, "
                      "proporcionando insights sobre o risco e a incerteza associados aos movimentos de preços "
                      "no mercado financeiro. "
                      "Portanto, o resultado obtido reflete a análise do Movimento Browniano Geométrico, "
                      "considerando as características históricas do ativo.",
                height=100)
